...
import { StyleSheet, Text, View, TouchableOpacity  } from 'react-native';// Use effect allows us to manage state of the component and any change in the componet
...
export default ({selectedColor, colorOptions, onSelect}) => {
    ...
    <View style={styles.container}>
        {colorOptions.map((colorName) => {
            return(<ColorButton onPress={() => onSelect(Colors[colorName])}
